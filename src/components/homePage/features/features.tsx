...
export default function Features() {
   const LEFT_CARD_CONTENT = (
      <>
         Our tool can be picked up and used for any hobbyist or company, and easily tailored to your
         personal needs. Clearly receive the dataset you envision, with support around the clock.
      </>
   );
   ...
   const RIGHT_CARD_CONTENT = (
      <>
         Seamlessly combine, auto-annotate, and enlarge datasets specific to your needs. Our tools
         easily adapt to existing datasets you have, and create more data / annotations.
      </>
   );
