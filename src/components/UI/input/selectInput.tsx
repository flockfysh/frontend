            ...
            classNames={
                {
                    ...
                    option(state) {
                        ...
                        if(state.isSelected) internalClass = `${ classes.selectOption } ${ classes.selectedSelectOption }`;
                        else if(state.isFocused) internalClass = `${ classes.selectOption } ${ classes.focusedSelectOption }`;
                        else internalClass = classes.selectOption;
