...
function TrainingLabels(props: React.ComponentPropsWithRef<'label'> & { labelColor?: string }) {
    ...
    return (
        <label 
            { ...smallProps } 
            className={ `${ trainingClasses.label } ${ props.className || '' }` }
        >
            <div 
                className={ trainingClasses.labelDot } 
                style={ {
            ...
            <form className={ classes.contentContainer } ref={ submissionRef }>
                ...
                <div className={ classes.formInputs }>
                                        ...
                                        return (
                                            <React.Fragment key={ index }>
                                                ...
                                                <CustomCreatableSelect 
                                                    ...
                                                    instanceId={ id }
                                                    isMulti={ true }
                                                    className={ trainingClasses.querySelect } 
                                                />
                                            </React.Fragment>
                                        );
                                    }
                    ...
                    <label className={ classes.labelledInputContainer }>
                        ...
                        <input 
                            type="range" 
                            id="num_images_to_ask_for_hf" 
                            name="num_images_to_ask_for_hf" 
                            min={ 20 }
