                            ...
                            <div className={ classes.infoContainerDiv }>
                                ...
                                <div className={ classes.api }>
                                    ...
                                    <button
                                        className={ classes.iconButton }
                                        onClick={ async () => {
                                            const newKey = await api.patch(
                                                `/api/users/apiUpdates/regenerateAPIKey`
                                            );
                            ...
                            <div className={ classes.limitsContentDiv }>
                                <div className={ classes.limitObject }>
                                    <h5 className={ classes.limit }>
                                        ...
                                        { props.transferLimit.toString() } /{ ' ' }
                                        {
                                            settings.BUSINESS_PARAMETERS
                                                .DATASET_TRANSFER_LIMIT
                                        }
                                        GB
                                    </h5>
