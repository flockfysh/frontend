...
const DatasetsOwned = () => {
    ...
    const recievedData = [
   {
       coverImg: 'https://images.unsplash.com/photo-1531720414817-c690e57c5637?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1333&q=80',
     ...
     <div className={ classes.mainDiv }>
      ...
      <div className={ classes.headDiv }>
                ...
                <label className={ classes.searchContainer }>
                    ...
                    <input
                        onChange={ (event) => {
                               setfinalData(recievedData.filter((data) =>  data.name.toLowerCase().includes(event.target.value.toLowerCase())));                               
                        } }
                        type="search"
      ...
      <div className={ classes.navDiv }>
               ...
               <button className={ classes.navButton } onClick={ () => {
                               setfinalData(recievedData.filter((data) => data.owner === 'praks'  ));                               
                        } } >Owned</button>
               <button className={ classes.navButton } onClick={ () => {
                               setfinalData(recievedData.filter( (data) => data.owner !== 'praks'  ));                               
                        } }>Bought</button>
