            ...
            <div className={ classes.profileDiv }>
                ...
                <div className={ classes.followDiv }>
                    <p className={ classes.followers }>
                        <span className={ classes.span }>{ props.following }</span>{' '}
                        following
                    </p>
                    <p className={ classes.followers }>
                        <span className={ classes.span }>{ props.followers }</span>{' '}
                        followers
                    </p>
            ...
            <div className={ classes.contentDiv }>
                ...
                <div className={ classes.finalDiv }>
                    <div className={ classes.navDiv }>
                        <button className={ classes.navButton } onClick={ () => props.updateTab(0) }>Datasets</button>
                        <button className={ classes.navButton } onClick={ () => props.updateTab(1) }>Activity</button>
                        <button className={ classes.navButton } onClick={ () => props.updateTab(2) }>Settings</button>
                    </div>
