            ...
            <div className= { classes.mainHypepageContainer }>
                <div className= { classes.mainHypepageWrapper }>
                    ...
                    <h1>Dataset Exchange Legal - Privacy Policy</h1>
                        ...
                        <li>documentation that can be used to verify your identity</li>
                        <li>data related to the datasets that users share or sell on our platform.</li>
                        <li>information about how users interact with our website or app, such as IP addresses, browser types, and device types.</li>
                        <li>data from communication between you and the Company, as part of using the Service</li>
                        <li>information and materials that you decide to post on the Website like comments, discussion, data</li>
                        <li>other potentially related data and information</li>
                        </ul>
                        <p>At any time during your use of the Services, you may decide to share some information or content publicly or privately.</p>
                        ...
                        <li>We use data related to datasets to facilitate the exchange or sale of data on our platform.</li>
                        <li>We use information about how users interact with our website or app to improve our services and user experience.</li>
                        <li>We use the information to enhance customer service by improving our understanding of your needs and preferences, thereby eliminating the need for you to repeatedly enter the same information</li>
                        <li>We use data to conduct research and analysis to identify areas for improvement in the Services, as well as other products and technologies offered by the Company</li>
                        <li>We use personal information to communicate with you, especially through the sending of welcome emails, information on technical service issues, reports, security announcements, information on new services available, legal notices and changes, responses to your requests, or any other information that we think might interest or be relevant for you</li>
                        <li>We use data to identify and resolve any issues or problems that may arise with the Service, ensuring their smooth operation</li>
                        <li>We use data to ensure and maintain security on our Services and/or Website, which may include detecting, preventing, investigating, or otherwise addressing fraud or other security issues</li>
                        <li>We use data to enforce any applicable terms of service or agreement, including investigations of potential violations thereof</li>
                        <li>We use data to protect against harm to the right, property, or safety of the Company, our Users, and our Customers (You) or the public</li>
                        ...
                        <ul>
                        <li>We do not sell or rent users' personal information to third parties.</li>
                        <li>We may share users' personal information with third-party service providers who help us provide our services.</li>
                        <li>We may share data related to datasets with other users on our platform.</li>
                        <li>We may share information about how users interact with our website or app with third-party analytics providers.</li>
                        <li>We may share User Information and Personal/Organizational Information collected by the Services with businesses that are legally part of the same group as the Company, or that become part of that group in the event of a change of control, merger, acquisition, or sale</li>
                        <li>We may occasionally share data with Third Party Service Providers to provide us with limited Services for our Services including but not limited to customer support, hosting websites, processing transactions, or performing statistical analysis of its Services. They will be required to maintain the confidentiality of the information and are prohibited from using it for any other purpose</li>
                        <li>We may, at any time during your use of the Services, or upon explicit request from us, you may consent to the disclosure of your information</li>
                        <li>We may disclose your information without your consent to comply with any applicable law, regulation, legal process, or governmental request</li>
                        ...
                        <li>We require employees who have access to sensitive data to sign an agreement to follow our company's confidentiality and security standards for handling sensitive data.</li>
                        <li>We regularly remind employees of our company's policy to keep customer information secure and confidential.</li>
                        </ul>
